...
/*Show all tables*/
SELECT * FROM CATEGORIES2783;
SELECT * FROM CUSTOMERS2783;
SELECT * FROM SHIPPERS2783;
SELECT * FROM SUPPLIERS2783;
SELECT * FROM EMPLOYEES2783;
SELECT * FROM PRODUCTS2783;
SELECT * FROM ORDERS2783;
SELECT * FROM ORDER_DETAILS2783;
